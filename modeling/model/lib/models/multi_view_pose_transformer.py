    ...
    def forward(self, views=None, meta=None):
        ...
        cam_K_crop = \
            torch.bmm(
                ...
                self.collate_first_two_dims(cam_K)).view(batch, nview, 3, 3)  # 以上相机参数数据均满足
        ...
        for lvl in range(nfeat_level):
            ...
            if self.projattn_posembed_mode == 'use_rayconv': # 此处对应论文中的图(2)b 即进行位置编码
                camera_rays.append(
