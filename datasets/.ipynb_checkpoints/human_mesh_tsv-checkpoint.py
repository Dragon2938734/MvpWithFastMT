...
import sys
sys.path.append('/autodl-tmp/FastMETRO/src')
...
if __name__ == '__main__':
    yaml_file = 'datasets/Tax-H36m-coco40k-Muco-UP-Mpii/train.yaml'
    MeshTSVYamlDataset(yaml_file, is_train, False, scale_factor)
